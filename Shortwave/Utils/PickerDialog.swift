...
//  Shortwave
//
//  Created by mobileworld on 6/21/20.
...
class PickerDialog: UIView, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    private func createContainerView() -> UIView {
        ...
        self.picker.setValue(UIColor(hex: "#333333"), forKeyPath: "textColor")
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.cancelButton.setTitleColor(UIColor(hex: "#555555"), for: .normal)
        self.cancelButton.setTitleColor(UIColor(hex: "#555555"), for: .highlighted)
        ...
        self.cancelButton.addTarget(self, action: #selector(self.buttonTapped(sender:)), for: UIControl.Event.touchUpInside)
        ...
        self.doneButton.setTitleColor(UIColor(hex: "#555555"), for: .normal)
        self.doneButton.setTitleColor(UIColor(hex: "#555555"), for: .highlighted)
        ...
        self.doneButton.addTarget(self, action: #selector(self.buttonTapped(sender:)), for: UIControl.Event.touchUpInside)
