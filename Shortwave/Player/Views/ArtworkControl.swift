...
class ArtworkControl: UIView, UIGestureRecognizerDelegate {
    ...
    private func setupAccessibilityLabels() {
        ...
        playPauseButton.accessibilityTraits = UIAccessibilityTraits(rawValue: super.accessibilityTraits.rawValue | UIAccessibilityTraits.button.rawValue)
    ...
    private func updateArtworkViewForTranslation(_ xTranslation: CGFloat) {
        ...
        let translation: CGFloat = rubberBandDistance(abs(xTranslation), dimension: width * 2 + 10.0, constant: 0.6)
